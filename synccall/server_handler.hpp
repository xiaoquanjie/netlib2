...
struct IServerHandler {
	virtual void OnOneWayDealer(const int msg_type, const netiolib::Buffer& request) = 0;
	virtual void OnTwoWayDealer(const int msg_type, const netiolib::Buffer& request, netiolib::Buffer& reply) = 0;
};
